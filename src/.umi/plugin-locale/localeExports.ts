import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'C:/Users/yud.dong/Desktop/new-product-actvity-admin/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'C:/Users/yud.dong/Desktop/new-product-actvity-admin/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from 'C:/Users/yud.dong/Desktop/new-product-actvity-admin/node_modules/react-intl';
...
export const localeInfo = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/Users/yud.dong/Desktop/new-product-actvity-admin/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/Users/yud.dong/Desktop/new-product-actvity-admin/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/Users/yud.dong/Desktop/new-product-actvity-admin/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('C:/Users/yud.dong/Desktop/new-product-actvity-admin/src/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
